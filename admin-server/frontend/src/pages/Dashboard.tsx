                  ...
                  {data.recent_sessions.length === 0 ? (
                    <tr>
                      <td colSpan={4} style={{ padding: "20px", textAlign: "center", color: "var(--text-tertiary)" }}>
                        No recorded employee sessions found.
                      </td>
                    </tr>
                  ) : (
          ...
          <div className="glass-panel" style={{ padding: "22px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {data.security_alerts.length === 0 ? (
                ...
                >
                  No active security alerts. All endpoint behavior normal.
                </div>
              ) : (
      ...
      {showInspector && (
        ...
        >
          ...
          <div>
            ...
            >
              {[
                { name: "Supervisor Agent", key: "supervisor", role: "Orchestration & Routing" },
                { name: "Session Analysis", key: "session_analysis_agent", role: "Payload & Metrics Processing" },
                { name: "Knowledge Agent", key: "knowledge_agent", role: "FAISS Vector Retrieval" },
                { name: "Security Agent", key: "security_agent", role: "Anomaly Detection & Rules" },
                { name: "Reporting Agent", key: "reporting_agent", role: "Executive Synthesis & Citations" },
              ].map((agent) => {
                const isReady = !agentStatus?.agents || agentStatus.agents[agent.key] !== "degraded";
                return (
                  <div
                    key={agent.name}
                    style={{
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        height: "7px",
                        borderRadius: "50%",
                        backgroundColor: isReady ? "var(--apple-green)" : "var(--apple-orange)",
                        boxShadow: isReady
